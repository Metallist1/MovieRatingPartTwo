...
{
    public class FakeRepository : IMovieReviewRepository
    {
        readonly private List<MovieRatings> _movieRatings = new List<MovieRatings>();
        public void Add(MovieRatings movRat)
        {
            _movieRatings.Add(movRat);
        }
        ...
        {
            return _movieRatings
                .Where(mr => mr.Reviewer == revieweID)
                .Where(mr => mr.Grade == grade)
                .Count();
        }
        ...
        {
           return _movieRatings
                .OrderByDescending(mr => averageRatingRecievedByMovie(mr.Grade))
                .Select(mr => mr.Movie)
                .Distinct()
                .Take(count)
                .ToList();
